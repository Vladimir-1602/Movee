...
console.log(width);
if (width <= 800) {
   let link = document.querySelector('.main-page__link');
   let target = document.querySelector('.main-page__row');
   target.after(link);
}


let mainSlider = new Swiper('.slider-autopark', {
   wrapperClass: 'slider-autopark__wrapper',
   slideClass: 'slider-autopark__slide',
   observer: true,
   observeParents: true,
   slidesPerView: 'auto',
   slidesPerGroup: 1,
   ...
   parallax: true,
   navigation: {
      nextEl: ".slider-autopark__next",
      prevEl: ".slider-autopark__prev",
   },
   pagination: {
